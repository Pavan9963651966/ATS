...
with st.container():
    ...
    role = st.selectbox("Select the Role:", ["Data Scientist", "Software Engineer", "Product Manager", "Marketing Specialist", "Sales Executive", "Other"], index=0, format_func=lambda x: f"🔍 {x}")
...
with col1:
    submit_check_score = st.button("Check Score 🔍")
with col2:
